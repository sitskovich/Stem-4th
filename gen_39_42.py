                ...
                'lesson39': {
                    ...
                    slides: [
                        ...
                        },
                        {
                            ...
                            content: `<div style="margin-bottom:15px;"><strong>Observe Energy Transfer:</strong> Flick the rope and watch the energy travel! Notice how the red dot just bobs up and down.</div><div id="threejs-container-l39" style="width:100%; height:450px; background:rgba(0,0,0,0.2); border-radius:15px; margin:15px 0; position:relative; overflow:hidden;"></div><div class="energy-controls"><button class="btn-debug" onclick="initSim(\'l39\')">🛠️ Debug</button><button class="btn-debug" onclick="initSim(\'l39\')">🛠️ Debug</button><button class="btn-drop" onclick="startRopeWave()">⚡ Send Wave</button><button class="btn-pause" onclick="pauseRopeWave()">⏸️ Pause</button><button class="btn-slow" onclick="slowMoRopeWave()">🐢 Slow Mo</button></div>`
                        },
                        {
                            title: `🚪 Exit Ticket`,
                ...
                'lesson40': {
                    ...
                    slides: [
                        ...
                        },
                        {
                            ...
                            content: `<div style="margin-bottom:15px;"><strong>Create Your Wave:</strong> Adjust the sliders to see how Amplitude and Wavelength change the wave!</div><div id="threejs-container-l40" style="width:100%; height:450px; background:rgba(0,0,0,0.2); border-radius:15px; margin:15px 0; position:relative; overflow:hidden;"></div><div class="energy-controls"><button class="btn-debug" onclick="initSim(\'l40\')">🛠️ Debug</button><button class="btn-debug" onclick="initSim(\'l40\')">🛠️ Debug</button><button class="btn-drop" onclick="waveIncAmp()">⬆️ Amplitude</button><button class="btn-drop" onclick="waveDecAmp()">⬇️ Amplitude</button><button class="btn-slow" onclick="waveIncLength()">↔️ Wavelength</button><button class="btn-slow" onclick="waveDecLength()">>< Wavelength</button></div>`
                        },
                        {
                            title: `🚪 Exit Ticket`,
                ...
                'lesson42': {
                    ...
                    slides: [
                        ...
                        },
                        {
                            ...
                            content: `<div style="margin-bottom:15px;"><strong>Test the Medium:</strong> Choose Air, Water, or Steel, and fire the sound wave to see who wins!</div><div id="threejs-container-l42" style="width:100%; height:450px; background:rgba(0,0,0,0.2); border-radius:15px; margin:15px 0; position:relative; overflow:hidden;"></div><div class="energy-controls"><button class="btn-debug" onclick="initSim(\'l42\')">🛠️ Debug</button><button class="btn-debug" onclick="initSim(\'l42\')">🛠️ Debug</button><button class="btn-drop" onclick="startSoundRace(\\\'air\\\')">💨 Air Wave</button><button class="btn-drop" onclick="startSoundRace(\\\'water\\\')">💧 Water Wave</button><button class="btn-drop" onclick="startSoundRace(\\\'steel\\\')">🛡️ Steel Wave</button><button class="btn-reset" onclick="resetSoundRace()">🔄 Reset</button></div>`
                        },
                        {
                            title: `🚪 Exit Ticket`,
